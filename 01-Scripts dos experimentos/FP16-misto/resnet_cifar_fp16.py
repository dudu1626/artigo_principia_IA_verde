...
def treinar_e_validar(modelo, treino_loader, validacao_loader, criterio, otimizador, epocas=50, nome_modelo='modelo.pth'):
    ...
    for epoca in range(epocas):
        ...
        for dados in treino_loader:
            ...
            # ver doc. https://pytorch.org/docs/stable/notes/amp_examples.html#amp-examples
            # Unscales the gradients of optimizer's assigned params in-place   ##### teste
            scaler.unscale_(otimizador)
    
            # Since the gradients of optimizer's assigned params are unscaled, clips as usual:  ###### teste
...
nome_modelo = 'ResNet34_CIFAR10_fp16.pth'
...
melhor_modelo = melhor_modelo.half()
