"""
# GoogLeNet para CIFAR10 - Original
"""
...
nome_modelo = 'GoogLeNet_CIFAR10.pth'
...
chaves_inesperadas = ["total_ops", "total_params", "inception_3a.total_ops", "inception_3a.total_params", "inception_3b.total_ops", "inception_3b.total_params"]
# Remover chaves inesperadas
state_dict = {k: v for k, v in state_dict.items() if k not in chaves_inesperadas}

# Criar instância do modelo
melhor_modelo = GoogLeNet().to(dispositivo)
